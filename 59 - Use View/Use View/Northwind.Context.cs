...
namespace Use_View
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual DbSet<Orders_96> Orders_96 { get; set; }
        ...
        public virtual DbSet<CustomersWithFax> CustomersWithFaxes { get; set; }
        public virtual DbSet<emp_det_vw> emp_det_vw { get; set; }
        ...
        public virtual int UpdateTwoProducts(Nullable<int> prodID1, Nullable<decimal> price1, Nullable<int> prodID2, Nullable<decimal> price2)
        {
            var prodID1Parameter = prodID1.HasValue ?
                new ObjectParameter("prodID1", prodID1) :
                new ObjectParameter("prodID1", typeof(int));
    
            var price1Parameter = price1.HasValue ?
                new ObjectParameter("price1", price1) :
                new ObjectParameter("price1", typeof(decimal));
    
            var prodID2Parameter = prodID2.HasValue ?
                new ObjectParameter("prodID2", prodID2) :
                new ObjectParameter("prodID2", typeof(int));
    
            var price2Parameter = price2.HasValue ?
                new ObjectParameter("price2", price2) :
                new ObjectParameter("price2", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateTwoProducts", prodID1Parameter, price1Parameter, prodID2Parameter, price2Parameter);
        }
    }
}
